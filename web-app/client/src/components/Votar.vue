<template>
  <div class="posts">
    <h1>Criar Votação</h1>
    <input type="text" v-model="VoteData.[0]" placeholder="Primeira Opcao">
      <br>
      <input type="text" v-model="VoteData.[1]" placeholder="Segunda Opcao">
      <br>
      <input type="text" v-model="VoteData[2]" placeholder="Terceira Opcao">
      <br>
      <input type="text" v-model="VoteData[3]" placeholder="Quarta Opcao">
      <br>
      <input type="text" v-model="VoteData[4]" placeholder="Quinta Opcao">
      <br>
