...
exports.registerVoter = async function (cpf, rg, nome) {
  ...
  try {
    ...
    if (userExists) {
      let response = {};
      console.log(`An identity for the user ${cpf} already exists in the wallet`);
      response.error = `Error! An identity for the user ${cpf} already exists in the wallet. Please enter
